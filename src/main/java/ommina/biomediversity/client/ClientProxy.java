...
import ommina.biomediversity.blocks.sappers.wither.WitherEssenceSapperScreen;
...
//region Overrides
    ...
    public void init() {
        ...
        ScreenManager.registerFactory( ModBlocks.WITHER_ESSENCE_SAPPER_CONTAINER, WitherEssenceSapperScreen::new);
